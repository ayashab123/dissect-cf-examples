 ...
 */
public class FirstFitJobScheduler2 implements JobLauncher, ConsumptionEvent {
	 ...
	 */
	public FirstFitJobScheduler2(final VirtualInfrastructure vi, final Progress pr) {
		this.vi = vi;
		this.progress = pr;
	}
